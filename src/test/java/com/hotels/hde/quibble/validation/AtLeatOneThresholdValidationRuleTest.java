...
public class AtLeatOneThresholdValidationRuleTest {
  ...
  public void validateThresholdValueInvalidColumnIndex() {
    ...
    AtLeastOneThresholdValidationRule rule = new AtLeastOneThresholdValidationRule();
    rule.validate(aTestCase);
  }

  @Test
  public void validateThresholdValueMultipleValuesSuccess() {
    TestCase aTestCase = new TestCase();
