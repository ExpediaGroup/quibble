...
public class MissingTestTypeValidationRuleTest {

  @Test(expected = IncorrectTestDefinitionException.class)
  public void validateMissingTestType() {
    TestCase aTestCase = new TestCase();

    aTestCase.setTestName("Test missing Test type");
    ...
    MissingTestTypeValidationRule rule = new MissingTestTypeValidationRule();
    rule.validate(aTestCase);
  }

  @Test
  public void validateTestTypeSuccess() {
    TestCase aTestCase = new TestCase();

    aTestCase.setTestType(TestType.DATAMATCH.name());
    aTestCase.setTestName("Testing Test type");
