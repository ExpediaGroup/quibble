...
public class AtMostTwoActionsValidationRule implements ValidationRule {
  ...
  public void validate(TestCase aTestCase) {
    if (aTestCase.getActions() != null && aTestCase.getActions().size() != REQUIRED_ACTIONS_COUNT) {
      String errorMessage = "A " + aTestCase.getTestType() + " test case must have exactly two actions";
