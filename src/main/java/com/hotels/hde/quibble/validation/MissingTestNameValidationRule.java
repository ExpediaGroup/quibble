...
public class MissingTestNameValidationRule implements ValidationRule {

  private final Logger logger = LoggerFactory.getLogger(getClass());

  @Override
  public void validate(TestCase aTestCase) {
    if (aTestCase.getTestName() == null) {
      String errorMessage = "Test name missing for: " + aTestCase.getTestType();
